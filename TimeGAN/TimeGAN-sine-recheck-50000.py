...
parameters['hidden_dim'] = 20 # 4 times of input features (=5)
...
vis_generated_data = np.asarray(generated_data)
vis_generated_data = vis_generated_data[:num_ori_data, :, :]

print("The synthetic data shape is:", vis_generated_data.shape)
print("The real data shape is:", np.asarray(ori_data).shape)
'''
