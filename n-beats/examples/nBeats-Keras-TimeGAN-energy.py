...
filename = "energy_data_TimeGAN_5000_sce2-1.npy"
...
for idx in range(num_times):
  mdname = 'nBeats-TimeGAN-energy-best.h5'
  ...
  logname = 'Log-' + "nBeats-TimeGAN-energy"  + '-.txt'
  ...
  modelname = os.path.join(src_path, "nBeats-TimeGAN-energy-best.h5")
