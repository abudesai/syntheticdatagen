...
filename = "sine_data_TimeGAN_5000_sce2-1.npy"
...
for idx in range(num_times):
  mdname = 'nBeats-TimeGAN-sines-best.h5'
  ...
  logname = 'Log-' + "nBeats-TimeGAN-sines"  + '-.txt'
  ...
  modelname = os.path.join(src_path, "nBeats-TimeGAN-sines-best.h5")
