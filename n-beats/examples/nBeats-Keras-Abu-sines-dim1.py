...
num_samples, time_steps, input_dim, output_dim = 1048551, 24, 1, 1
backend = NBeatsKeras(
        input_dim=input_dim,
...
mdname = 'nBeats-Abu-sines-dim1-best.h5'
...
logname = 'Log-' + "nBeats-Abu-sines"  + '-.txt'
...
modelname = os.path.join(src_path, "nBeats-Abu-sines-dim1-best.h5")
