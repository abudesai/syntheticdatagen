...
# to generate sines data for Scenario-2
...
filename = "sines_data_TimeGAN_5000_sce2-wTest-0-010.npy"
...
for idx in range(num_times):
  mdname = 'nBeats-TimeGAN-sines-best-sce2-wTest-0-010.h5'
  ...
  logname = 'Log-' + "nBeats-TimeGAN-sines-sce2-wTest-0-010"  + '-.txt'
  ...
  modelname = os.path.join(src_path, "nBeats-TimeGAN-sines-best-sce2-wTest-0-010.h5")
