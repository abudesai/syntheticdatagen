...
# load the generated data -- RCGAN's data
src_path = "/data/home/stufs1/zuwang/dg21/RGAN/experiments/syn_data/"
filename = "rgan_energy_synth_data_epoch1000.npy"
...
for idx in range(num_times):
  mdname = 'nBeats-RCGAN-energy-best.h5'
  ...
  logname = 'Log-' + "nBeats-RCGAN-energy"  + '-.txt'
  ...
  modelname = os.path.join(src_path, "nBeats-RCGAN-energy-best.h5")
